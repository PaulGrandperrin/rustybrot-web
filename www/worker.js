...
function asmInitialized() {
	...
	var nDataBytes = size_x*size_y*4;
	var dataPtr = Module._malloc(nDataBytes);
	var dataHeap = new Uint32Array(Module.HEAPU32.buffer, dataPtr, size_x*size_y);
	...
	while(true) {
		...
		get_buddhabrot(dataHeap.byteOffset, size_x, size_y, -1.6, 0.8, -1.2, 1.2, 1, 1000000, num_sample);
		//get_buddhabrot(dataHeap.byteOffset, size_x, size_y, -0.5, 0.4, 0.4, 0.5, 1, 1000, num_sample);
		//get_buddhabrot(dataHeap.byteOffset, size_x, size_y, -0.043-zoom, -0.043+zoom, -0.986-zoom, -0.986+zoom, 1, 1000000, num_sample);
